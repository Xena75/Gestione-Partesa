    ...
    try {
      ...
      if (response.ok) {
        ...
        if (response.status === 409) {
          ...
          setErrors({ general: errorData.error || 'Errore nella creazione della società' });
        }
      }
    } catch (err) {
        ...
        <div className="row justify-content-center">
          <div className="col-md-8">
            <div className="alert alert-success text-center" role="alert">
              ...
              <h4 className="alert-heading">Società creata con successo!</h4>
              <p>La nuova società è stata aggiunta al sistema.</p>
              <hr />
        ...
        <div className="col-12">
          ...
          <nav aria-label="breadcrumb" className="mb-4">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active" aria-current="page">Nuova Società</li>
            </ol>
          </nav>

          {/* Header */}
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h1 className="h3 mb-0">Nuova Società</h1>
