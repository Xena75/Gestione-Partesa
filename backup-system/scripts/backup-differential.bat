...
REM Prima crea un job per il backup differenziale
"%MYSQL_BIN%\mysql.exe" -h %MYSQL_HOST% -P %MYSQL_PORT% -u %MYSQL_USER% -e "INSERT INTO backup_management.backup_jobs (backup_type, status, started_at) VALUES ('differential', 'completed', NOW());" 2>> "%LOG_FILE%"
